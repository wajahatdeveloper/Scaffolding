...
public class BasicExample : MonoBehaviour
{
	...
	// Example of AutoRef being used to get the transform of a named GameObject.
	[AutoRef(AutoRefTargetType.NamedGameObjects, new string[] { "NamedGameObject" })]
	[SerializeField]
	Transform m_TransformOfNamedGameObject;

	// Example of AutoRef being used to get all the Transforms of some named GameObjects.
	[AutoRef(AutoRefTargetType.NamedGameObjects, new string[] { "AnotherNamedGameObject", "YetAnotherNamedGameObject" })]
	[SerializeField]
	List<Transform> m_TransformsOfNamedGameObjects;
}
