...
{
    public class RadialLayoutGroup3D : LayoutGroup3D
    {
        public float distance;
        public float startAngle;
        public float spacing;
        
        private AxisAlignment childAlignmentX = AxisAlignment.Middle;
        private AxisAlignment childAlignmentY = AxisAlignment.Middle;
        private AxisAlignment childAlignmentZ = AxisAlignment.Middle;
        private Direction childDirection = Direction.LowerToUpper;
        private Bool3 childControlSize = new Bool3();
        private Bool3 childForceExpand = new Bool3();
         ...
         public override void UpdateLayout()
        {
            ...
            foreach (LayoutElement3D element in elementList)
            {
                ...
                element.transform.localPosition = c_center + vPos * distance;
